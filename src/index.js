...
function parseQueryString(url) {
  // todo
  if (url === undefined || url === 'https://google.com' || url === 'https://google.com?') {
    return {};
  }
  ...
  return (
    <div className="App">
      ...
      <div>
        ...
        <div>
          <p style={{ fontWeight: 'bold', textAlign: 'center' }}>TodoList</p>
          ...
          <ul>
            {list.map((v, index) => {
              return (
                <div style={{ display: 'flex' }}>
                  <li key={index} onClick={changeItem.bind(this, index)}>
                    {v}
                  </li>
